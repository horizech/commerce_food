                                                          ...
                                                          ? Wrap(
                                                              ...
                                                              children: [
                                                                ...item
                                                                    ...
                                                                    .options
                                                                    .entries
                                                                    .map((entry) => UpText(item.value.selectedVariation!.options.values.last ==
                                                                            entry
                                                                                .value
                                                                        ? getAttributeName(
                                                                            entry)
                                                                ...
                                                                (cItem) =>
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    cItem.selectedVariation !=
                                                                                null &&
                                                                            cItem.selectedVariation!.options.isNotEmpty
                                                                        ? Wrap(
                                                                            crossAxisAlignment:
                                                                                WrapCrossAlignment.center,
                                                                            children: [
                                                                              ...cItem.selectedVariation!.options.entries.map((entry) => UpText(cItem.selectedVariation!.options.values.last == entry.value ? getAttributeName(entry) : "${getAttributeName(entry)}, "))
                                                                            ],
                                                                          )
                                                                        : const SizedBox(),
                                                                    ...
                                                                    cItem.selectedProductAttributes !=
                                                                                null &&
                                                                            cItem.selectedProductAttributes!.isNotEmpty
                                                                        ? Wrap(
                                                                            crossAxisAlignment:
                                                                                WrapCrossAlignment.center,
                                                                            children: [
